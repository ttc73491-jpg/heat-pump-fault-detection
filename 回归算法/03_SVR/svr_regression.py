...
OUTPUT_DIR = r'C:\Users\ccc\Desktop\algorithm\回归算法\03_SVR\output'
...
# ============================================================
# GridSearchCV for SVR hyperparameters
# ============================================================
print('\n' + '=' * 60)
...
# ============================================================
print('\n' + '=' * 60)
print('Final SVR Model Evaluation')
print('=' * 60)
...
metrics_df.to_csv(os.path.join(OUTPUT_DIR, 'svr_metrics.csv'), index=False)

# Engineering tolerance: error within +/-5%
...
tolerance_df.to_csv(os.path.join(OUTPUT_DIR, 'svr_tolerance.csv'), index=False)

# ============================================================
# Figure 1: True vs Predicted scatter plot
# ============================================================
fig, ax = plt.subplots(figsize=(8, 8))
ax.scatter(y_test, y_test_pred, alpha=0.7, edgecolors='white', linewidth=0.5, c='#2196F3')
...
ax.set_title(f'SVR -- True vs Predicted (Test R2={test_metrics["R2"]:.4f})', fontsize=14)
...
plt.close()
print('Figure 1 saved: svr_true_vs_pred.png')
...
sns.histplot(errors, kde=True, bins=40, color='#2196F3', alpha=0.6, ax=ax)
ax.axvline(x=0, color='red', linestyle='--', linewidth=1.5)
ax.axvline(x=-2.5, color='green', linestyle=':', linewidth=1, alpha=0.5)
ax.axvline(x=2.5, color='green', linestyle=':', linewidth=1, alpha=0.5)
ax.set_xlabel('Prediction Error (Predicted - True) [%]', fontsize=12)
ax.set_ylabel('Frequency', fontsize=12)
ax.set_title(f'SVR -- Prediction Error Distribution (SD={test_metrics["SD"]:.4f})', fontsize=14)
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'svr_error_dist.png'), dpi=300, bbox_inches='tight')
plt.close()
print('Figure 2 saved: svr_error_dist.png')

print('\nSVR regression complete.')
