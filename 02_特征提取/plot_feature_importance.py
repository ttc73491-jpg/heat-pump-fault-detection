...
importance_df = pd.read_csv(f'{data_dir}/gini_feature_importance.csv')
...
ax.set_title('Feature Importance Ranking based on Gini Impurity\n(Heat Pump Cooling System Fault Detection)', fontsize=14)
...
output_path = f'{data_dir}/feature_importance_plot.png'
