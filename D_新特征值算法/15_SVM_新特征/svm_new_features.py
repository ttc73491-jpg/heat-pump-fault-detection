...
output_dir = r'C:\Users\ccc\Desktop\algorithm\15_SVM_新特征\output'
...
# ==================== 数据加载 ====================
print("=" * 70)
print("SVM — 新39特征数据集 (15 selected features)")
print("=" * 70)
...
plot_cm(cm_flat, TARGET_NAMES, f'SVM Flat 10-Class (15 features)\nAccuracy: {acc_flat*100:.2f}%', 'svm_flat_10class_cm.png')
...
plot_cm(cm_s1, SEVERITY_NAMES, 'SVM Stage 1: 4-Class Severity (15 features)', 'svm_stage1_cm.png')
...
for group_id in range(4):
    ...
    plot_cm(cm_sub, group_label_names,
            f'SVM {GROUPS[group_id]["name"]} Group (15 features)',
...
# ==================== 对比 ====================
print("\n" + "=" * 70)
print("对比: 新特征(39→15) vs 原始(30→20)")
print("=" * 70)
print(f"{'指标':<30} {'新特征SVM':>12} {'原始SVM':>12} {'瞬态SVM':>12}")
print("-" * 68)
print(f"{'特征数':<30} {len(SELECTED_FEATURES):>12} {'20':>12} {'21':>12}")
print(f"{'Stage 1 Accuracy':<30} {acc_s1*100:>11.2f}% {'43.92%':>12} {'53.33%':>12}")
print(f"{'Overall 10-class':<30} {overall_acc:>11.2f}% {'53.25%':>12} {'60.08%':>12}")

# RF vs SVM 对比
print(f"\n{'='*70}")
print(f"新特征: RF vs SVM 对比")
print(f"{'='*70}")
print(f"{'指标':<30} {'RF':>12} {'SVM':>12}")
print("-" * 56)
rf_overall = 0  # will be filled after both run
print(f"{'Stage 1 Accuracy':<30} {'(见RF结果)':>12} {acc_s1*100:>11.2f}%")
print(f"{'Overall 10-class':<30} {'(见RF结果)':>12} {overall_acc:>11.2f}%")

# 保存结果
with open(os.path.join(output_dir, 'svm_new_features_results.txt'), 'w', encoding='utf-8') as f:
    f.write("=" * 70 + "\n")
    f.write("SVM — New 39 Features (15 selected)\n")
    f.write("=" * 70 + "\n\n")
...
print(f"\n结果已保存至: {output_dir}/svm_new_features_results.txt")
print("=" * 70)
print("SVM新特征分类完成!")
print("=" * 70)
