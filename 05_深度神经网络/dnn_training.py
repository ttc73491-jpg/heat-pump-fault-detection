...
# 7. 构建DNN模型 (M9配置: 3层 16-16-8)
print("\n[5] 构建DNN模型 (M9配置: 3层 16-16-8)...")
model = Sequential([
...
print("DNN模型评估指标结果")
print("=" * 70)
print(f"\n  模型配置: M9 (3层: 16-16-8, Dropout 0.2)")
print(f"  过采样: {'是' if USE_OVERSAMPLE else '否'}")
print(f"  特征数量: {len(selected_features)}")
...
with open(results_path, 'w', encoding='utf-8') as f:
    ...
    f.write("最佳配置 M9: 3层隐藏层 (16-16-8)\n")
    f.write("=" * 70 + "\n\n")
    f.write(f"模型配置: M9 (3层: 16-16-8, Dropout 0.2)\n")
